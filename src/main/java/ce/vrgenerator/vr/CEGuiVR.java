...
public class CEGuiVR extends GuiContainer {
	 ...
	 * GUIテクスチャ
	 */
	private static final ResourceLocation gui = new ResourceLocation("vrgenerator", "textures/gui/guivisibleraysolar.png");
	...
	public void drawGuiContainerForegroundLayer(final int par1, final int par2) {
		...
		this.fontRenderer.drawString(name, (this.xSize-this.fontRenderer.getStringWidth(name))/2, 6, 0x404040);
		this.fontRenderer.drawString(inv, 8, this.ySize-96+2, 0x404040);
	}
